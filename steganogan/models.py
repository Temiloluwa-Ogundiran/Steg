...
class SteganoGAN(object):
    ...
    @staticmethod
    @contextmanager
    def _legacy_optimizer_compat():
        """Temporarily tolerate optimizer objects pickled by very old torch versions."""

        original_setstate = Optimizer.__setstate__
        ...
        Optimizer.__setstate__ = compat_setstate
        try:
            yield
        finally:
            Optimizer.__setstate__ = original_setstate
